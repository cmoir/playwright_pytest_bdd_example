...
@scenario('example_tests.feature', 'user can navigate to the ican page',features_base_dir='features')
def test_example_is_working(page):
    print('starting bdd test')

@given('Given a example site')
def goto_website(page):
    main_page = MainPage(page)
    page.goto("https://example.com")
    main_page.verifiy_header()

@when('When they navigate to the ican website')
...
@then('Then they are able to select all the menus')
